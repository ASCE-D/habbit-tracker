...
export async function generateMetadata({ params }: Props) {
  ...
  const siteName = process.env.SITE_NAME || "Insightaction";
  const authorName = process.env.AUTHOR_NAME || "Deepesh Genani";
...
export default async function Post({ params }: Props) {
  ...
  return (
    <>
      ...
      <section className="bg-dark mt-10 pb-16 pt-10 lg:pb-24 lg:pt-16">
        <div className="container">
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4">
              {/* Hero Section with Cover Image */}
              <div className="wow fadeInUp relative z-20 mb-10 overflow-hidden rounded-xl shadow-lg md:mb-16">
                <div className="relative h-[300px] md:h-[400px] lg:h-[500px]">
                  ...
                  />
                  <div className="from-dark-700/90 to-dark-700/20 absolute inset-0 bg-gradient-to-t"></div>
                </div>
              ...
              <div className="-mx-4 flex flex-wrap">
                <div className="w-full px-4 lg:w-8/12">
                  <div className="blog-details xl:pr-10">
                    {/* Use the MDXContent component instead of dangerouslySetInnerHTML */}
                    ...
                    <div className="mt-12 flex justify-center">
                      <Link
                        href="/journal/habits"
                        className="hover:bg-primary rounded-md bg-primaryOrange px-6 py-3 text-lg font-semibold text-white transition"
                      >
                        <div className="flex">
                          {" "}
                          Start Tracking Now for Free
                    ...
                    <div className="mt-12 flex flex-wrap items-center gap-3">
                      ...
                      {["Design", "Development", "Technology"].map((tag, i) => (
                        <Link
                          key={i}
                          href={`/tag/${tag.toLowerCase()}`}
                          className="text-body-color hover:bg-primary dark:bg-dark-2 dark:hover:bg-primary rounded-md bg-primaryOrange px-3 py-1 text-sm transition hover:text-white dark:text-white"
                        >
                          {tag}
                        </Link>
                      ))}
                ...
                {/* Sidebar */}
                <div className="mt-12 w-full px-4 lg:mt-0 lg:w-4/12">
                  <div className="sticky top-24 space-y-10">
                    {/* Newsletter */}
                    <div className="wow fadeInUp rounded-xl border border-white/10 bg-white/5 p-6">
                      <Newsletter />
                    </div>

                    {/* Popular Articles */}
                    {/* <div className="wow fadeInUp dark:bg-dark-2 rounded-xl bg-white/5 p-6 shadow-md">
                      <h3 className="text-dark relative mb-6 text-xl font-semibold dark:text-white">
                        Popular Articles
                        <span className="bg-primary mt-2 block h-1 w-12"></span>
                      </h3>
                    ...
                    {/* Ad Banner */}
                    <div className="wow fadeInUp overflow-hidden rounded-xl shadow-md">
                      <Image
          ...
          {/* Related Articles */}
          {/* <div className="mt-16 border-t border-gray-900 pt-16 dark:border-gray-700">
            <div className="-mx-4 flex flex-wrap">
              <div className="w-full px-4">
                <h2 className="text-dark relative mb-10 text-2xl font-semibold dark:text-white sm:text-[28px]">
                  Related Articles
                  <span className="bg-primary mt-2 block h-1 w-12"></span>
                </h2>
              </div>
