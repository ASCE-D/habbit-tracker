...
export default function GoalsAndHabitsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Set Your Goals and Habits</h1>
      ...
      <form onSubmit={handleGoalSubmit} className="mb-8">
        ...
        <div className="mb-4">
          <label htmlFor="goalDescription" className="block text-sm font-medium text-gray-700">Goal Description</label>
          <textarea
            id="goalDescription"
