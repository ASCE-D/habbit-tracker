    ...
    <>
      <header
        className={`ud-header left-0 top-0 z-40 flex w-full items-center ${
          sticky
            ? "shadow-nav border-stroke dark:border-dark-3/20 dark:bg-dark/10 fixed z-[999]  border-b bg-black backdrop-blur-[5px]"
                ...
                {session?.user ? (
                  <>
                    ...
                    {pathUrl !== "/" || sticky ? (
                      <button
                        onClick={() => signOut()}
                        className="signUpBtn rounded-lg bg-primaryOrange bg-opacity-100 px-6 py-3 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-20"
                      >
                        Sign Out
                      </button>
                    ) : (
                      <button
                        onClick={() => signOut()}
                        className="signUpBtn rounded-lg bg-primaryOrange bg-opacity-20 px-6 py-3 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-100 "
                      >
                        Sign Out
                      </button>
                    )}
                  ...
                  <>
                    {pathUrl !== "/" ? (
                      <>
                        <Link
                          href="/signin"
                          className="text-dark bg-primaryOrange px-7 py-3 text-base font-medium hover:opacity-70 dark:text-white"
                        >
                          Sign In
                        </Link>
                        {/* <Link
